...
const Contact = () => {
  ...
  const saveContact = async (event) => {  
    ...
      await axios  
        
     .post("https://45hhlngbr3.execute-api.us-east-1.amazonaws.com/dev/contact", contactState)
     //here hast be added the api gateway post url      
      ...
      <div className="contact-container">
        ...
        <div className="container page-title text-center">
          ...
          <span className="title-head-subtitle">
           open for software Engineer position
          </span>
        </div>
        {/* Main Heading Ends */}
        <div className="container">
          <div className="row contact">
              ...
              <ul className="custom-list">
                <li>
                  <h6 className="font-weight-600">
                    ...
                    <span className="contact-content">+904 21 184 010</span>
                  </h6>
                </li>
                <li>
                  <h6 className="font-weight-600">
                    ...
                    <span className="contact-content">merakidane1991@gmail.com</span>
                  </h6>
                </li>
              ...
              <div className="social">
                ...
                <ul className="list-inline social social-intro text-center p-none">
                  <li className="facebook">
                    <a title="Facebook" href="https://www.facebook.com/merhawi.kidane.9">
                      <i className="fa fa-facebook" />
                    </a>
                  </li>
                  <li className="twitter">
                    <a title="Twitter" href="https://twitter.com/MerhawiMarek?">
            ...
            <div className="col-12 col-md-8 col-xl-8 rightside">
              ...
              <form className="contactform" saveContact={(e) => saveContact(e)}>
                <div className="row">
                  {/* Name Field Starts */}
